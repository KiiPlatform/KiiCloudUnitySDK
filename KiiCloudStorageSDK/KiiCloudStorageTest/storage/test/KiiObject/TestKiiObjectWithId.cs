...
{
    [TestFixture()]
    public class TestKiiObjectWithId
    {

        [Test()]
        public void Test_1_1_CreateWithId_NotInCloud_NoPatch_NotOverwrite_EtagNone ()
        {
        ...
        [Test()]
        public void Test_1_4_CreateWithId_NotInCloud_NoPatch_Overwrite_EtagNone ()
        {
            Kii.Initialize("appId", "appKey", Kii.Site.US);
            MockHttpClientFactory factory = new MockHttpClientFactory();
            Kii.HttpClientFactory = factory;
        ...
        [Test()]
        public void Test_1_13_CreateWithId_InCloud_NoPatch_NotOverwrite_EtagNone ()
        {
            Kii.Initialize("appId", "appKey", Kii.Site.US);
            MockHttpClientFactory factory = new MockHttpClientFactory();
            Kii.HttpClientFactory = factory;
        ...
        [Test()]
        public void Test_1_14_CreateWithId_InCloud_NoPatch_NotOverwrite_EtagMatch ()
        {
            Kii.Initialize("appId", "appKey", Kii.Site.US);
            MockHttpClientFactory factory = new MockHttpClientFactory();
            Kii.HttpClientFactory = factory;
        ...
        [Test()]
        public void Test_1_17_CreateWithId_InCloud_NoPatch_Overwrite_EtagMatch ()
        {
            Kii.Initialize("appId", "appKey", Kii.Site.US);
            MockHttpClientFactory factory = new MockHttpClientFactory();
            Kii.HttpClientFactory = factory;
        ...
        [Test()]
        public void Test_1_20_CreateWithId_InCloud_Patch_NoOverwrite_EtagMatch ()
        {
            Kii.Initialize("appId", "appKey", Kii.Site.US);
            MockHttpClientFactory factory = new MockHttpClientFactory();
            Kii.HttpClientFactory = factory;
        ...
        [Test()]
        public void Test_1_22_CreateWithId_InCloud_Patch_Overwrite_EtagNone ()
        {
            Kii.Initialize("appId", "appKey", Kii.Site.US);
            MockHttpClientFactory factory = new MockHttpClientFactory();
            Kii.HttpClientFactory = factory;
        ...
        [Test()]
        public void Test_1_23_CreateWithId_InCloud_Patch_Overwrite_EtagMatched ()
        {
            Kii.Initialize("appId", "appKey", Kii.Site.US);
            MockHttpClientFactory factory = new MockHttpClientFactory();
            Kii.HttpClientFactory = factory;
