...
namespace KiiCorp.Cloud.Storage
{
    ...
    public class TestKiiBucketACL
    {
        ...
        #region KiiBucket.ListAclEntries()
        ...
        public void Test_0001_ListAclEntries_server_error ()
        {
            LogIn("test-user-00001");
            // set response
        ...
        [Test(), KiiUTInfo(
            action = "When we call ListAclEntries() and Server returns only QUERY entry,",
