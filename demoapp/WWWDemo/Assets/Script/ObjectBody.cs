...
[ExecuteInEditMode()]
public class ObjectBody : ScriptBase {
						...
						if (e2 == null)
						{
							...
							o1.UploadBody("image/png", body, (KiiObject o2, Exception e3)=>{
								if (e3 == null)
								{
									...
									, (KiiObject o3, long completed, long total)=>{
										this.message = "Downloading... " + completed + "/" + total;
									});
								}
								else
								{
							...
							, (KiiObject o2, long completed, long total)=>{
								this.message = "Uploading... " + completed + "/" + total;
							});
						}
						else
						{
