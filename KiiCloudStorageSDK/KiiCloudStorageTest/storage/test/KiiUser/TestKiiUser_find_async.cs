...
{
    [TestFixture()]
    public class TestKiiUser_find_async
    {
        ...
        private void SetStandardFindResponse()
        {
            client.AddResponse(200, "{" +
        ...
        private void SetStandardMemberResponse()
        {
            client.AddResponse(200, "{" +
                "\"groups\" : [{" +
        ...
        private void SetStandardOwnerResponse()
        {
            client.AddResponse(200, 
                @"
                {
        ...
        public void Test_0003_findByUsername_null ()
        {
            ...
            KiiUser found = null;
            Exception exp = null;
            KiiUser.FindUserByUserName(null, (KiiUser u, Exception e) => {
                found = u;
                exp = e;
            });
            Assert.IsNull(found);
        ...
        public void Test_0100_findByEmail ()
        {
            ...
            KiiUser found = null;
            Exception exp = null;
            KiiUser.FindUserByEmail("test@test.com", (KiiUser u, Exception e) => {
                found = u;
                exp = e;
            });
            Assert.IsNull (exp);
        ...
        public void Test_0200_findByPhone ()
        {
            ...
            KiiUser found = null;
            Exception exp = null;
            KiiUser.FindUserByPhone("+818011112222", (KiiUser u, Exception e) => {
                found = u;
                exp = e;
            });
            Assert.IsNull(exp);
        ...
        public void Test_0203_findByPhone_null ()
        {
            ...
            KiiUser found = null;
            Exception exp = null;
            KiiUser.FindUserByPhone(null, (KiiUser u, Exception e) => {
                found = u;
                exp = e;
            });
            Assert.IsNull(found);
        ...
        public void Test_0204_findByPhone_invalid ()
        {
            ...
            KiiUser found = null;
            Exception exp = null;
            KiiUser.FindUserByPhone("invalidPhone", (KiiUser u, Exception e) => {
                found = u;
                exp = e;
            });
            Assert.IsNull(found);
        ...
        public void Test_1000_MemberOfGroups()
        {
            this.LogIn();

            // set Response
            this.SetStandardMemberResponse();

            IList<KiiGroup> groups = null;
            Exception exp = null;
            KiiUser.CurrentUser.MemberOfGroups((IList<KiiGroup> gs, Exception e)=> {
                groups = gs;
                exp = e;
            });
        ...
        public void Test_1001_MemberOfGrups_noId()
        {
            ...
            IList<KiiGroup> groups = null;
            Exception exp = null;
            KiiUser.BuilderWithName("newUser").Build().MemberOfGroups((IList<KiiGroup> gs, Exception e)=> {
                groups = gs;
                exp = e;
            });
        ...
        public void Test_1002_MemberOfGrups_no_group()
        {
            ...
            // set Response
            client.AddResponse(200, "brokenResp");
        ...
        [Test(), KiiUTInfo(
            ...
            expected = "passing Group in the callback."
            )]
        ...
        public void Test_2000_OwnerOfGroups()
        {
            this.LogIn();
            ...
            IList<KiiGroup> groups = null;
            Exception exp = null;
            KiiUser.CurrentUser.OwnerOfGroups((IList<KiiGroup> gs, Exception e)=> {
                groups = gs;
                exp = e;
            });
